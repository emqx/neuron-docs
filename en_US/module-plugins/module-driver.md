...
The a1e plug-in is used to access Mitsubishi's A series, FX3U, FX3G, iQ-F series PLCs via Ethernet.
...
| 区域 | 数据类型 | 属性       | 备注                                 |
| ---- | -------- | ---------- | ------------------------------------ |
| X    | bit      | read/write | Input relay (FX/iQ-F)                |
| Y    | bit      | read/write | Output relay (FX/iQ-F)               |
| M    | bit      | read/write | Internal relay (FX/iQ-F)             |
| L    | bit      | read/write | Latch relay (FX/iQ-F)                |
| F    | bit      | read/write | Annunciator (FX/iQ-F)                |
| B    | bit      | read/write | Link relay (FX/iQ-F)                 |
| SB   | bit      | read/write | Link special relay (FX/iQ-F)         |
| S    | bit      | read/write | (FX/iQ-F)                            |
| D    | all      | read/write | Data register (FX/iQ-F)              |
| W    | all      | read/write | Link register (FX/iQ-F)              |
| TS   | bit      | read/write | Timer Contact (FX/iQ-F)              |
| TC   | bit      | read/write | Timer Coil (FX/iQ-F)                 |
| TN   | all      | read/write | Timer Current value (FX/iQ-F)        |
| STS  | bit      | read/write | Retentive timer Contact (FX/iQ-F)    |
| STC  | bit      | read/write | Retentive timer Coil (FX/iQ-F)       |
| STN  | all      | read/write | Retentive timer (FX/iQ-F)            |
| CS   | bit      | read/write | Counter Contact (FX/iQ-F)            |
| CC   | bit      | read/write | Counter Coil (FX/iQ-F)               |
| CN   | all      | read/write | Counter Current value (FX/iQ-F)      |
| LCS  | bit      | read/write | Long Counter Contact (FX/iQ-F)       |
| LCC  | bit      | read/write | Long Counter Coil (FX/iQ-F)          |
| LCN  | all      | read/write | Long Counter Current value (FX/iQ-F) |
| SB   | bit      | read/write | Link special relay (FX/iQ-F)         |
| SW   | all      | read/write | Link special register (FX/iQ-F)      |
| SM   | bit      | read/write | Special relay (FX/iQ-F)              |
| SD   | all      | read/write | Specical register (FX/iQ-F)          |
| Z    | all      | read/write | Index register (FX/iQ-F)             |
| LZ   | all      | read/write | Long Index register (FX/iQ-F)        |
| DX   | bit      | read/write | Link input (FX/iQ-F)                 |
| DY   | bit      | read/write | Link output(FX/iQ-F)                 |
| R    | all      | read/write | File register (FX/iQ-F)              |
