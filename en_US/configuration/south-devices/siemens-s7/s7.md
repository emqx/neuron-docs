...
| DB   | int8/uint8/int16/uint16/bit/int32/uint32/float/double/string/wstring | read/write | global DB block | Variable Memory V, DB index 1 |
...
| DB1.DBW12.20D | string  | In a data block of 1, the starting data word is 12, string length is 20, process data as WString |
