...
You can simulate an IEC60870-5-104 device and test its connection to Neuron using the [IEC 60870-5-104 Server Simulator](https://www.freyrscada.com/iec-60870-5-104-Client-Simulator.php). For specific steps, refer to [IEC 60870-5-104 Server Simulator](./example/server-simulator/simulator.md).
