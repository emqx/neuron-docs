...
| **驱动主题前缀**   | 根据主题前缀生成一系列主要用于南向驱动功能的主题，实现特定驱动的特定功能。 |
...
* action/req : 用于接收驱动特定指令。
* action/resp : 用于返回驱动特定指令的响应。

* flist/req : 用于驱动接收文件列表请求。
* flist/resp : 用于返回文件列表响应。

* fup/req : 用于驱动上传文件前，打开文件请求。
* fup/resp : 用于返回打开文件响应。

* fupdata/req : 用于驱动上传文件数据请求。
* fupdata/resp : 用于返回上传文件数据响应。

* fdown/req : 用于驱动下载文件前，打开文件请求。
* fdown/resp : 用于返回打开文件响应。

* fdowndata/req : 用于驱动下载文件数据请求。
* fdowndata/resp : 用于返回下载文件数据响应。
