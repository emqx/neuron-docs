...
Neuron 是一款现代的工业物联网连接服务器，可以连接多种使用标准协议或设备专有协议的工业设备，帮助实现工业物联网平台与各种设备的互联互通。作为一款轻量级工业软件，Neuron 支持运行在各种有限资源的物联网边缘硬件设备上。旨在解决以数据为中心的自动化设备数据难以统一访问的问题，为智能制造提供数据基础支撑。
